...
```markdown
|              Роль             |   CPU   |   RAM  |    SSD    |  HDD (тб)  | Количество |
|:-----------------------------:|:-------:|:------:|:---------:|:----------:|:----------:|
| Сессии, Профиль, Рекомендации | 32 ядра | 128 Гб |   100 Гб  |      -     |      3     |
...
![](https://raw.githubusercontent.com/BoldinDmitry/highload_project/main/files/balancing.png)
